...
void initializeContext() { context = new Context{}; }
...
void mapAction(InputActionId actionId, DeviceType deviceType, DeviceAction deviceAction, ActionTrigger trigger) {
	Mapping mapping;
	mapping.actionId = actionId;
	DeviceInputMapping deviceInputMapping;
	deviceInputMapping.deviceType = deviceType;
	deviceInputMapping.deviceAction = deviceAction;
	deviceInputMapping.triggers.push_back(trigger);
	mapping.mapping.push_back(deviceInputMapping);
