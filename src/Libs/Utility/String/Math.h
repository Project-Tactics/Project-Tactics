...
public:
	static std::string to(const glm::vec2& val) { return fmt::format("{}, {}", val.x, val.y); }
...
public:
	static std::string to(const glm::vec3& val) { return fmt::format("{}, {}, {}", val.x, val.y, val.z); }
...
public:
	static std::string to(const glm::vec4& val) { return fmt::format("{}, {}, {}, {}", val.x, val.y, val.z, val.w); }
