...
public:
	...
	virtual std::unique_ptr<FileHandle<nlohmann::ordered_json>>
	createJsonFile(const std::filesystem::path& path) const = 0;
...
public:
	...
	createJsonFile(const std::filesystem::path& path) const override;
